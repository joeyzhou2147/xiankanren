...
<head>
    ...
    <link href="<?php echo base_url('assets/css/L1/me.css'); ?>" rel="stylesheet">
...
<body style="max-width:1000px;height: 617px;background-color: #EFEFEF;">
...
<div class="font-xihei bc-me-3div-container">
    ...
    <div class="me-3div-background">
                    ...
                    <div class="inner-card-HTML ">
                        ...
                        <div class="inner-card-row2 bc-flex">
                            ...
                            <div class="inner-card-row2-col1 bc-flex">
                                <div class="bc-flex">
                                    <img src="<?php echo base_url('assets/images/default_person1.png'); ?>" width="50px" height="50px"/>
                                </div>
                            </div>
                        ...
                        <div class="inner-card-row3">
                            <div class="inner-card-row3-content bc-flex">
                                ...
                                <div class="inner-card-row3-content-dis" style="float:left;margin-left:10px;"
                    ...
                    <div class="inner-notify-HTML ">
                        ...
                        <div class="notify-row1 notify-border">
                            <div class="notify-col1 bc-flex">
                                <div class="bc-flex">
                                    <image src="<?php echo base_url('assets/images/default_person1.png'); ?>" height="60" width="auto"/>
                                </div>
                            </div>
                        ...
                        <div class="notify-row2 notify-border">
                            ...
                            <div class="notify-col2">
                                ...
                                <div class="notify-col2-row2 bc-flex">
                                    <img src="<?php echo base_url('assets/images/collect01.png'); ?>" height="20px" width="auto"/>
                                </div>
                                <div class="notify-col2-row3">
                                    <font color="grey">1 minute ago</font>
                                </div>
                        ...
                        <div class="notify-row3 notify-border">
                            ...
                            <div class="notify-col2">
                                ...
                                <div class="notify-col2-row2 bc-flex"><font color="grey">欢迎使用先看人:)</font></div>
                                <div class="notify-col2-row3">
                                    <font color="grey">1 minute ago</font>
                                </div>
                            </div>
        ...
        <div class="me-3div-row2 bc-flex">
            <div class="notify-button whitebubble">

                <div class="notify-button-row1 bc-flex">
                    <img class="" src="<?php echo base_url('assets/images/me_public01.png'); ?>" width="62px" height="auto"/>
                </div>
