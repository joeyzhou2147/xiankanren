    ...
    <div class="bc-flex" style="justify-content: flex-start;">
        <div class="bc-flex bc-top-bar">
            ...
            <div class="bc-top-title bc-flex">
                <div class="bc-top-half bc-flex font-xihei" onclick="toHref('<?php echo base_url("level_1/home"); ?>')">
                    <div class="bc-top-title-unchecked bc-flex">看投资人</div>
                </div>
                <div class="bc-top-half bc-flex font-xihei">
                    <div class="bc-top-title-checked bc-flex">看创业者</div>
                </div>
            </div>
