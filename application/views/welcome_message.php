          ...
          <section class='col-xs-12 col-sm-6 col-md-6'>
            <section>
              <h2>先看人的计划</h2>
                ...
                <p>If you created祝泽宇 the application from the web console, you'll need to manually clone the repository to your local system. Copy the application's source code Git URL and then run:</p>
...
$ git push</pre>
                  ...
                  <ul>
                    <li><a href="<?php echo base_url("level_1/home"); ?>">Learn more about deploying and building your application</a></li>
          ...
          <section class="col-xs-12 col-sm-6 col-md-6">
			  <section class="codeigniter">
				<h2>关于先看人</h2>
				<p>1、我们总部在上海，开发团队在北美</p>
				<p>2、三个合伙人：牛肉哥，Zeyu Zheng, Yu Zhou</p>
				<p>3、忠诚，努力，创新是我们的经营理念，我们致力于服务社会，奉献社会</p>
				<p>4、先看人以创新的创意，专业的研发能力、服务用户为核心的基本原则，打造最优秀的产品</p>
			  </section>
